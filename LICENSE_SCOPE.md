...
除下列例外外，本仓库由开心输入法项目自行开发的源代码和文档按根目录
[`LICENSE`](LICENSE) 中的 Apache License 2.0 授权。

Apache-2.0 **不自动覆盖**仓库中标明为第三方作品的数据、模型、代码或二进制文件。
这些内容继续适用各自的上游许可证：
...
`assets/`、`icons/` 中的项目品牌名称和图标随源码提供，但 Apache-2.0
不授予使用“开心输入法”名称或标识暗示官方认可、赞助或背书的权利。

提交贡献即表示你有权提交该内容，并同意按照 Apache-2.0 授权该贡献；明确标为
第三方同步或补丁的内容除外，其许可证必须在提交中单独说明。
