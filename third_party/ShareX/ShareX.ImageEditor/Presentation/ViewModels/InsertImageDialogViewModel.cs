...
namespace ShareX.ImageEditor.Presentation.ViewModels
{
    ...
    {
        public string Title => EditorLocalizer.InsertImage;
        public string Description => EditorLocalizer.InsertImageDescription;
        ...
        {
            ImageSummary = EditorLocalizer.IncomingImageSummary(imageWidth, imageHeight);
