...
public sealed class ToolbarCustomizationItemViewModel : ViewModelBase
{
    ...
    {
        new ToolbarItemDefinition(FileItemId, null, EditorLocalizer.File, EditorIcons.FileMenu, "", true, false, false),
        CreateToolDefinition(EditorTool.Select, EditorLocalizer.Tr("Select", "选择"), EditorIcons.ToolSelect, "V", beginGroupByDefault: true),
        CreateToolDefinition(EditorTool.Rectangle, EditorLocalizer.Tr("Rectangle", "矩形"), EditorIcons.ToolRectangle, "R"),
        CreateToolDefinition(EditorTool.Ellipse, EditorLocalizer.Tr("Ellipse", "椭圆"), EditorIcons.ToolEllipse, "E"),
        CreateToolDefinition(EditorTool.Line, EditorLocalizer.Tr("Line", "直线"), EditorIcons.ToolLine, "L"),
        CreateToolDefinition(EditorTool.Arrow, EditorLocalizer.Tr("Arrow", "箭头"), EditorIcons.ToolArrow, "A"),
        CreateToolDefinition(EditorTool.Freehand, EditorLocalizer.Tr("Freehand", "自由画笔"), EditorIcons.ToolFreehand, "F"),
        CreateToolDefinition(EditorTool.Text, EditorLocalizer.Tr("Text", "文字"), EditorIcons.ToolText, "T"),
        CreateToolDefinition(EditorTool.SpeechBalloon, EditorLocalizer.Tr("Speech Balloon", "气泡"), EditorIcons.ToolSpeechBalloon, "O"),
        CreateToolDefinition(EditorTool.Step, EditorLocalizer.Tr("Step", "步骤"), EditorIcons.ToolStep, "N"),
        CreateToolDefinition(EditorTool.Image, EditorLocalizer.Tr("Image", "图片"), EditorIcons.ToolImage, "I"),
        CreateToolDefinition(EditorTool.Emoji, EditorLocalizer.Tr("Emoji", "表情"), EditorIcons.ToolEmoji, "J"),
        CreateToolDefinition(EditorTool.Cursor, EditorLocalizer.Tr("Cursor", "光标"), EditorIcons.ToolCursor, "K"),
        CreateToolDefinition(EditorTool.Highlight, EditorLocalizer.Tr("Highlight", "高亮"), EditorIcons.ToolHighlight, "H"),
        CreateToolDefinition(EditorTool.SmartEraser, EditorLocalizer.Tr("Smart Eraser", "智能橡皮擦"), EditorIcons.ToolSmartEraser, "W"),
        CreateToolDefinition(EditorTool.Blur, EditorLocalizer.Tr("Blur", "模糊"), EditorIcons.ToolBlur, "B"),
        CreateToolDefinition(EditorTool.Pixelate, EditorLocalizer.Tr("Pixelate", "像素化"), EditorIcons.ToolPixelate, "P"),
        CreateToolDefinition(EditorTool.Magnify, EditorLocalizer.Tr("Magnify", "放大镜"), EditorIcons.ToolMagnify, "M"),
        CreateToolDefinition(EditorTool.Spotlight, EditorLocalizer.Tr("Spotlight", "聚光灯"), EditorIcons.ToolSpotlight, "S"),
        CreateToolDefinition(EditorTool.Crop, EditorLocalizer.Tr("Crop", "裁剪"), EditorIcons.ToolCrop, "C", beginGroupByDefault: true),
        CreateToolDefinition(EditorTool.CutOut, EditorLocalizer.Tr("Cut Out", "抠图"), EditorIcons.ToolCutOut, "U"),
        new ToolbarItemDefinition(BackgroundItemId, null, EditorLocalizer.Background, EditorIcons.PanelBackground, "", true, true, false),
        new ToolbarItemDefinition(ImageEffectsItemId, null, EditorLocalizer.ImageEffects, EditorIcons.PanelEffects, "", true, true, false)
    };
    ...
    public string ToolTip
    {
        get
        {
            ...
            if (Id == ImageEffectsItemId)
            {
                ...
                return $"{header}\n{EditorLocalizer.FavoriteImageEffectsHint}";
            }
