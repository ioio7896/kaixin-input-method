...
public partial class EmojiPickerDialogViewModel : ObservableObject
{
    ...
    [ObservableProperty]
    private string _searchWatermark = EditorLocalizer.LoadingEmojis;
    ...
    public async Task InitializeAsync()
    {
        ...
        IsLoading = true;
        ResultsSummary = EditorLocalizer.LoadingEmojis;
        SearchWatermark = EditorLocalizer.LoadingEmojis;
    ...
    private async Task RefreshResultsAsync()
    {
        ...
        SearchWatermark = EditorLocalizer.SearchEmojisWatermark(result.CategoryCount);
    ...
    private EmojiQueryResult BuildQueryResult(string search, string selectedGroup)
    {
        ...
        if (string.IsNullOrWhiteSpace(search))
        {
            ...
            resultsSummary = string.IsNullOrEmpty(selectedGroup)
                ? EditorLocalizer.BrowseEmojis
                : $"{selectedGroup} • {categoryEntries.Length} {EditorLocalizer.Tr("emojis", "个表情")}";
        }
        else
        {
            ...
            resultsSummary = EditorLocalizer.SearchResults(filteredEntries.Length);
        }
