    ...
    public partial class MainViewModel : ViewModelBase
    {
        ...
        public string ActiveToolName
        {
            get
            {
                ...
                return tool switch
                {
                    EditorTool.Select => EditorLocalizer.Tr("Select", "选择"),
                    EditorTool.Rectangle => EditorLocalizer.Tr("Rectangle", "矩形"),
                    EditorTool.Ellipse => EditorLocalizer.Tr("Ellipse", "椭圆"),
                    EditorTool.Line => EditorLocalizer.Tr("Line", "直线"),
                    EditorTool.Arrow => EditorLocalizer.Tr("Arrow", "箭头"),
                    EditorTool.Freehand => EditorLocalizer.Tr("Freehand", "自由画笔"),
                    EditorTool.Text => EditorLocalizer.Tr("Text", "文字"),
                    EditorTool.Cursor => EditorLocalizer.Tr("Cursor", "光标"),
                    EditorTool.Emoji => EditorLocalizer.Tr("Emoji", "表情"),
                    EditorTool.SpeechBalloon => EditorLocalizer.Tr("Speech Balloon", "气泡"),
                    EditorTool.Step => EditorLocalizer.Tr("Step", "步骤"),
                    EditorTool.Blur => EditorLocalizer.Tr("Blur", "模糊"),
                    EditorTool.Pixelate => EditorLocalizer.Tr("Pixelate", "像素化"),
                    EditorTool.Magnify => EditorLocalizer.Tr("Magnify", "放大镜"),
                    EditorTool.Spotlight => EditorLocalizer.Tr("Spotlight", "聚光灯"),
                    EditorTool.SmartEraser => EditorLocalizer.Tr("Smart Eraser", "智能橡皮擦"),
                    EditorTool.Highlight => EditorLocalizer.Tr("Highlight", "高亮"),
                    EditorTool.Crop => EditorLocalizer.Tr("Crop", "裁剪"),
                    EditorTool.CutOut => EditorLocalizer.Tr("Cut Out", "抠图"),
                    EditorTool.Image => EditorLocalizer.Tr("Image", "图片"),
                    _ => EditorLocalizer.Tr("Select", "选择")
                };
            }
        }
