...
namespace ShareX.ImageEditor.Presentation.ViewModels
{
    public partial class MainViewModel : ViewModelBase
    {
        ...
        private static ObservableCollection<BackgroundModeOption> BuildBackgroundModeOptions()
        {
            ...
            [
                new() { Mode = CanvasBackgroundMode.Gradient, DisplayName = EditorLocalizer.BackgroundModeGradient },
                new() { Mode = CanvasBackgroundMode.Color, DisplayName = EditorLocalizer.BackgroundModeColor },
                new() { Mode = CanvasBackgroundMode.Transparent, DisplayName = EditorLocalizer.Transparent },
                new() { Mode = CanvasBackgroundMode.Image, DisplayName = EditorLocalizer.BackgroundModeImage }
            ];

            if (EditorServices.DesktopWallpaper?.IsSupported == true)
            {
                options.Add(new BackgroundModeOption { Mode = CanvasBackgroundMode.Wallpaper, DisplayName = EditorLocalizer.BackgroundModeWallpaper });
            }
