...
namespace ShareX.ImageEditor.Presentation.ViewModels
{
    public partial class ConfirmationDialogViewModel : ObservableObject
    {
        ...
        public ConfirmationDialogViewModel(Action onYes, Action onNo, Action onCancel,
            ...
            string message = "")
        {
            Title = string.IsNullOrEmpty(title) ? EditorLocalizer.ExitConfirmation : title;
            Message = string.IsNullOrEmpty(message) ? EditorLocalizer.UnsavedChangesPrompt : message;
