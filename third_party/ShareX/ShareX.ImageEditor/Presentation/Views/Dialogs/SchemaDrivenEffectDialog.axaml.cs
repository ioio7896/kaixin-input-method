...
public partial class SchemaDrivenEffectDialog : UserControl, IEffectDialog
{
    ...
    public string Title => EditorLocalizer.TranslateEffectLabel(Definition.Name);
    ...
    private void RequestPreview()
    {
        ...
        PreviewRequested?.Invoke(this, BuildEffectEventArgs(Title));
    }
    ...
    private void OnApplyClick(object? sender, RoutedEventArgs e)
    {
        ...
        ApplyRequested?.Invoke(this, BuildEffectEventArgs(EditorLocalizer.AppliedEffect(Title)));
    }
    ...
    private async void OnBrowseFilePathClick(object? sender, RoutedEventArgs e)
    {
        ...
        {
            Title = EditorLocalizer.SelectParameter(parameterState.Label),
            AllowMultiple = false,
