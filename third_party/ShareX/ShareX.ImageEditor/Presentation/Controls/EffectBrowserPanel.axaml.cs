...
namespace ShareX.ImageEditor.Presentation.Controls
{
    ...
    public partial class EffectBrowserPanel : UserControl
    {
        ...
        private readonly EffectCategory _recentCategory = new(EditorLocalizer.TranslateEffectCategory("Recent"), headerHint: EditorLocalizer.RecentHeaderHint);
        private readonly EffectCategory _favoritesCategory = new(EditorLocalizer.TranslateEffectCategory("Favorites"), headerHint: EditorLocalizer.FavoritesHeaderHint);
        ...
        private void UpdateSearchWatermark()
        {
            ...
            searchBox.PlaceholderText = EditorLocalizer.SearchImageEffects(totalEffectCount);
        }
        ...
        private void InitializeEffects()
        {
            ...
            {
                var category = new EffectCategory(EditorLocalizer.TranslateEffectCategory(categoryEnum.ToString()));
        ...
        private void AddEditorOperations(EffectCategory category, ImageEffectCategory targetCategory)
        {
            ...
            {
                category.AddEffect(
                    EditorLocalizer.TranslateEffectLabel(operation.BrowserLabel),
                    operation.Icon,
                    EditorLocalizer.TranslateEffectDescription(operation.Description),
        ...
        private void AddCatalogDrivenEffects(EffectCategory category, ImageEffectCategory targetCategory)
        {
            foreach (EffectDefinition definition in ImageEffectCatalog.GetByCategory(targetCategory))
            {
                ...
                category.AddEffect(
                    EditorLocalizer.TranslateEffectLabel(definition.BrowserLabel),
                    definition.Icon,
                    EditorLocalizer.TranslateEffectDescription(definition.Description),
