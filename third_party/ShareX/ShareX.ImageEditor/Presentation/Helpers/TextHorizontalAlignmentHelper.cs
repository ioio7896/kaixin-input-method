...
public static class TextHorizontalAlignmentHelper
{
    public static string GetDisplayName(TextHorizontalAlignment alignment)
    {
        ...
        {
            TextHorizontalAlignment.Left => EditorLocalizer.Tr("Left", "左对齐"),
            TextHorizontalAlignment.Center => EditorLocalizer.Tr("Center", "居中"),
            TextHorizontalAlignment.Right => EditorLocalizer.Tr("Right", "右对齐"),
            _ => EditorLocalizer.Tr("Center", "居中")
        };
    }
