...
namespace ShareX
{
    internal static class Program
    {
        ...
        // Version the embedded protocol identity so an older bundled process
        // cannot consume newer commands and ignore their private arguments.
        public const string MutexName = "A6AFBFC0-3577-476C-876B-37420C76482C";
        public static readonly string PipeName = $"{Environment.MachineName}-{Environment.UserName}-{AppName}-KaixinIntegration-V3";
        ...
        public static bool KaixinIntegration { get; private set; }
        ...
        private static void Main(string[] args)
        {
            ...
            SystemOptions.ForceKaixinOfflineMode();
            UpdatePersonalPath();
        ...
        private static void Run()
        {
            ...
            KaixinIntegration = CLI.IsCommandExist("KaixinPrewarm", "KaixinRectangleRegion", "KaixinCaptureWindow");
            ...
            // The embedded capture/editor experience belongs to Kaixin Input
            // Method, so keep it consistently in Simplified Chinese regardless
            // of the system UI language or an older ShareX profile.
            if (KaixinIntegration)
            {
                Settings.Language = SupportedLanguage.SimplifiedChinese;
            }
        ...
        private static void DebugWriteFlags()
        {
            ...
            if (KaixinIntegration) flags.Add(nameof(KaixinIntegration));
