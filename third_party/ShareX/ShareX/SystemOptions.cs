...
namespace ShareX
{
    public static class SystemOptions
    {
        ...
        public static void ForceKaixinOfflineMode()
        {
            // KaixinShareX is bundled only as a local screenshot/editor component.
            // Never allow upstream ShareX update checks or upload jobs to be enabled
            // by defaults, persisted settings, or missing registry policy values.
